 ...
 *
 * Contributors:
 *  Bernd Hufmann - Copied from Eclipse Nebula Project and modifications
 *                  for our needs
 ******************************************************************************/
...
public class ColorMap {
     ...
     */
    public RGB drawImage(
            int dataWidth, int dataHeight, double max, double min, long val){
...
//                int index = (int) ((dataArray.get(y * dataWidth + x) - min) / (max - min) * 255);
                ...
                RGB pixel = colorsLookupTable[index];
                return pixel;
